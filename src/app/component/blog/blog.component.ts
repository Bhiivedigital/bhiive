...
export class BlogComponent {
  ...
  constructor(private schemaService: SchemaService, private meta: Meta, private title: Title, private blogService: BlogService) {}
  ...
  ngOnInit() {
    ...
    this.meta.updateTag({ rel: 'canonical', href: 'https://bhiive.com/blog' });
